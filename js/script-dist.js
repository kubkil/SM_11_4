...
function Phone(brand, price, color) {
  //constructor function, named with capital Letter, executed with 'new' operator - capital letter indicates that is should be run with 'new'
  this.brand = brand;
  this.price = price;
  this.color = color;
}
...
var SamsungX = new Phone('Samsung', 1500, 'black');
var HuaweiY = new Phone('Huawei', 3000, 'blue');
